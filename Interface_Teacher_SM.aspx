    ...
    <form id="form1" runat="server">
        ...
        <div id="globllink">
            <ul>
                ...
                <li class="li_1"><a><asp:Button ID="Button10" runat="server" Width="100px" Text="设置考试时间" OnClick="Button5_Click" BackColor="Transparent" BorderColor="Transparent" BorderStyle="None" ForeColor="White" /></a></li>
                <!---填充导航菜单栏>
                <li><a></a></li>
                <li><a></a></li>
                <li><a></a></li>
