    ...
    <form id="form1" runat="server">
        <div  id="top">
            <p id="top_p_r">
                ...
                <asp:Button ID="Button1" runat="server"  Text=" 注销 " BackColor="#3399FF" BorderColor="Black" BorderStyle="Dotted" BorderWidth="1px" />
            </p>
        </div>
        <div id="globllink">
            <ul>
        ...
        <div id="middle">
            <div id="d_message">
                ...
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server"  Text="发布" OnClick="Button2_Click" />
            </div>
        </div>
    </form>
</body>
