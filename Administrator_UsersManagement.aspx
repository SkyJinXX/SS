    ...
    <form id="form1" runat="server">
        ...
        <div id="globllink">
            <ul>
                ...
                <li class="li_1"><a><asp:Button ID="Button6" runat="server" Width="100px" Text="个人信息修改" OnClick="Button7_Click" BackColor="Transparent" BorderColor="Transparent" BorderStyle="None" ForeColor="White" /></a></li>
                <li class="li_1"><a><asp:Label ID="Label3" runat="server" Width="100px" Enabled="False" Visible="False"></asp:Label></a></li>
                <!---填充导航菜单栏>
                <li><a></a></li>
                <li><a></a></li>
                <--->
        ...
        <div id="d_body">
            ...
            <div id="T_S">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="750px">
                    <Columns>
        ...
        <div id="T_T">
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" Width="600px">
                <Columns>
        ...
        <div id="T_A">
            <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" Width="600px">
            <Columns>
