...
<body>
    <form id="form1" runat="server">
        ...
        <div id="d_menu_1">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Button6" runat="server" Width="100px" Text="个人信息修改" OnClick="Button6_Click" />
                    </td>
                </tr>
            </table>
        </div>
        <div id="search">
            ...
            <asp:TextBox ID="TextBox1" runat="server" Width="500px" Height="17px"></asp:TextBox>
