        ...
        <div id="d_body">
            <div id="menu">
                <table id="T_menu">
                    ...
                    <tr>
                        <th>
                            <asp:Button ID="Button2" runat="server" Height="50px" Width="100px" Text="课件学习" OnClick="Button2_Click1" />
                        </th>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                            <asp:Button ID="Button7" runat="server" Height="50px" Width="100px" Text="进度排行" OnClick="Button7_Click" />
                        </th>
                    </tr>
                    <tr>
                        <th>
