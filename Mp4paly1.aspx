<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mp4paly1.aspx.cs" Inherits="Mp4paly1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="Button1" runat="server"  Text="返回" Width="142px" OnClick="Button1_Click2" />
        </div>
    </form>
</body>
</html>
