...
public partial class Interface_Student_Menu : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            objConnection.Open();
            String SelectSql = "select Course.Cname ,Crelease from S_C_Transcript,Trelease,Course where S_C_Transcript.Cid = Trelease.Cid and S_C_Transcript.Cid = Course.Cid and S_C_Transcript.Sid IN (select Sid from S_U where Uusername = '" + (String)Session["username"] + "')";
